...
class PlayerData:
    """Encapsulates all player state and properties."""
    def __getitem__(self, key):
        """Allow dictionary-style access for backward compatibility."""
        if key == "inventory":
            return self.inventory
        elif key == "active_slots":
            return self.active_slots
        elif key == "selected_slot":
            return self.selected_slot
        elif key == "slot_at_mouse":
            return self.slot_at_mouse
        else:
    ...
    def __setitem__(self, key, value):
        ...
        if key == "inventory":
            ...
            self.active_slots = value
        elif key == "selected_slot":
            self.selected_slot = value
        elif key == "slot_at_mouse":
            self.slot_at_mouse = value
        else:
...
class WorldConfig:
    """Encapsulates world data including portals, terrain, and collision maps."""
    def __init__(self):
        self.portals = [
        ...
        self.mine_exit = [
            {"x_real": 200, "y_real": 528, "x": 26 * 8 - 128, "y": 74 * 8 - 128, "id": 0},
            {"x_real": 336, "y_real": 304, "x": 90 * 8 - 128, "y": 44 * 8 - 128, "id": 0},
        ...
        self.tile_id_collision_spirit_sub = {
            "no_collision_terrain": [(31, 28), (14, 28), (15, 28), (14, 29), (15, 29), (14, 30), (15, 30), (14, 31), (15, 31),
                (13, 25), (14, 25), (13, 26), (14, 26), (4, 25), (8, 18), (8, 19), (8, 20), (8, 21),
                (9, 18), (9, 19), (9, 20), (9, 21), (10, 18), (10, 19), (10, 20), (10, 21),
                (11, 18), (11, 19), (11, 20), (11, 21), (12, 17), (12, 18), (13, 17), (13, 18),
                (14, 17), (14, 18), (15, 17), (15, 18), (12, 22), (12, 23), (13, 22), (13, 23),
                (14, 22), (14, 23), (15, 22), (15, 23), (16, 22), (16, 23), (17, 22), (17, 23),
                (16, 24), (16, 25), (16, 26), (16, 27), (17, 24), (17, 25), (17, 26), (17, 27),
                (14, 19), (14, 20), (14, 21), (12, 20), (13, 20), (6, 18), (6, 19), (7, 18), (7, 19), (5, 19), (6, 20)],
            "terrain": [(31, 29), (4, 24), (8, 22), (9, 22), (8, 23), (9, 23), (8, 24), (9, 24), (8, 25), (9, 25),
                ...
                (10, 28), (10, 29), (10, 30), (10, 31), (11, 28), (11, 29), (11, 30), (11, 31),
                (12, 28), (12, 29), (12, 30), (12, 31), (13, 28), (13, 29), (13, 30), (13, 31),
                (6, 30), (6, 31), (7, 30), (7, 31), (8, 30), (8, 31), (9, 30), (9, 31)],
        }
        ...
        self.tile_id_collision = {
            "no_collision_terrain": [(0, 0), (1, 2), (0, 4), (19, 0), (20, 0), (19, 1), (20, 1), (17, 2), (19, 2), (20, 2),
                (17, 3), (18, 3), (19, 3), (20, 3), (17, 4), (18, 4), (19, 4), (20, 4), (21, 4),
                (17, 5), (18, 5), (19, 5), (20, 5), (21, 5), (17, 6), (18, 6), (19, 6), (20, 6), (21, 6),
                (5, 11), (13, 11), (15, 11), (16, 11), (3, 13), (4, 13), (5, 13), (6, 13), (8, 13), (14, 13),
                (14, 14), (13, 15), (14, 15), (15, 15), (16, 15)],
            "terrain": [(0, 2), (1, 3), (21, 0), (22, 0), (23, 0), (24, 0), (25, 0), (26, 0),
                (21, 1), (22, 1), (23, 1), (24, 1), (25, 1), (26, 1), (14, 2), (21, 2), (22, 2), (23, 2), (24, 2),
                (21, 3), (22, 3), (23, 3), (24, 3), (22, 6), (23, 6), (26, 6), (27, 6),
                (11, 7), (17, 7), (18, 7), (19, 7), (20, 7), (21, 7), (22, 7), (23, 7), (29, 7),
                (17, 8), (18, 8), (19, 8), (20, 8), (21, 8), (22, 8), (23, 8),
                (17, 9), (18, 9), (19, 9), (20, 9), (17, 10), (18, 10), (19, 10), (20, 10)],
            "sign": [(5, 7), (5, 8), (5, 9)],
            "forest": [(1, 0), (22, 4), (23, 4), (24, 4), (25, 4), (22, 5), (23, 5), (24, 5), (25, 5),
                (24, 6), (25, 6), (24, 7), (25, 7), (24, 8), (25, 8), (22, 9), (23, 9), (24, 9), (25, 9), (22, 10), (23, 10)],
            "path": [(8, 4), (11, 4), (8, 5), (11, 5), (7, 6), (8, 6), (9, 6), (11, 6), (6, 7), (9, 7), (10, 7), (12, 7),
                (6, 9), (7, 9), (8, 9), (21, 9), (4, 10), (5, 10), (21, 10), (24, 10), (25, 10), (26, 10), (27, 10), (29, 10),
                (4, 11), (17, 11), (18, 11), (19, 11), (20, 11), (21, 11), (22, 11), (23, 11), (24, 11), (25, 11), (26, 11), (27, 11), (28, 11), (29, 11),
                (4, 12), (5, 12), (6, 12), (7, 12), (17, 12), (18, 12), (19, 12), (20, 12), (21, 12), (22, 12), (23, 12), (24, 12), (25, 12), (26, 12), (27, 12), (28, 12), (29, 12),
                (7, 13), (16, 13), (17, 13), (18, 13), (19, 13), (20, 13), (21, 13), (22, 13), (23, 13), (24, 13), (25, 13), (26, 13), (27, 13), (28, 13), (29, 13),
                (3, 14), (4, 14), (5, 14), (7, 14), (16, 14), (17, 14), (18, 14), (19, 14), (20, 14), (21, 14), (22, 14), (23, 14), (24, 14), (25, 14), (26, 14), (27, 14), (28, 14), (29, 14),
                (3, 15), (4, 15), (5, 15), (17, 15), (18, 15), (19, 15), (20, 15), (21, 15), (22, 15), (23, 15), (24, 15), (25, 15), (26, 15), (27, 15), (28, 15), (29, 15)],
            "water": [(12, 4), (12, 5), (27, 9), (28, 9), (28, 10)],
            "wood_bridge": [(9, 4), (10, 4), (10, 5)],
            "brick_bridge": [(9, 12)],
            "graveyard": [(2, 0), (1, 1), (2, 1), (11, 13), (12, 13)],
            "ice": [],
        }


class CombatSystem:
    """Handles combat mechanics, attacks, and effects."""
    def __init__(self):
        self.effect_ui = {
...
class UIManager:
    """Manages the user interface state and components."""
    def __init__(self):
        self.hud = None
        self.qol_loot_ui = []
        self.settings = False
        ...
        self.pause_ui_text_id = [(107, 48, 29), (72, 48, 35), (72, 40, 63), (72, 40, 23), (116, 40, 19)]
        self.temp = []

    def is_in_game(self):
        return self.hud in self.ingame_hud
...
class Game:
    def __init__(self):
        ...
        for y in range(239):
            for x in range(215):
                ...
                for type_of_tile in self.world.tile_type:
                    if self.world.tile_id_collision[type_of_tile].count(tile) == 1:
    ...
    def update(self):
        if self.ui.ingame_hud.count(self.ui.hud) == 1:
            self.update_player()
    ...
    def update_player(self):
        ...
        if self.state != STATE_SPIRIT_SUB_ZONE:
            ...
            for type_of_tile in self.world.tile_type:
                if self.world.tile_id_collision[type_of_tile].count(tile_of_player) == 1:
                    if self.world.tile_type[type_of_tile] != None:
                        if (
                            self.world.tile_type[type_of_tile].count(
                                pyxel.image(0).pget(
                                    tile_of_player[0] * 8
                                    + (player_x + move[0] * 2) % 8
                                    + move[0] * 1,
            ...
            for type_of_tile in self.world.tile_type_spirit_sub:
                if (
                    self.world.tile_id_collision_spirit_sub[type_of_tile].count(
                        tile_of_player
                    )
                    == 1
                ):
                    if self.world.tile_type_spirit_sub[type_of_tile] != None:
                        if (
                            self.world.tile_type_spirit_sub[type_of_tile].count(
                                pyxel.image(1).pget(
                                    tile_of_player[0] * 8
                                    + (player_x + move[0] * 2) % 8
                                    + move[0] * 1,
            ...
            if (
                math.sqrt(
                    (
                        ...
                        - self.world.portals[self.player.portal_id]["x"]
                    )
                    ** 2
                    + (
                        (self.player.y + move[1] * 2)
                        - self.world.portals[self.player.portal_id]["y"]
                    )
                    ** 2
                )
                > 139
    ...
    def update_outofgame_ui(self):
        ...
        if pyxel.btnp(pyxel.KEY_ESCAPE, 15, 1):
            self.ui.hud = None
            self.state_entry_frame = pyxel.frame_count + 1
        if self.ui.hud == "pause":
            for i in range(len(self.ui.pause_ui_text_id)):
                if (
                    pyxel.mouse_x > 8
                    and pyxel.mouse_x < 12 + self.ui.pause_ui_text_id[i][2]
            ...
            if self.player.selected_slot != [None, None]:
                self.ui.hud = self.ui.pause_sub_hud[self.player.selected_slot[1]]
                self.player.slot_at_mouse = [None, None]

        elif self.ui.hud == "quit_warning":
            for i in range(2):
                if (
    ...
    def init_path_map_spirit_sub_mine(self):
        ...
        mine = self.world.mine_path[self.world.portals[self.player.portal_id]["id"]]
        self.path_map = []
        for y in range(mine["h"] // 8):
            ...
            for x in range(mine["l"] // 8):
                ...
                for type_of_tile in self.world.tile_type_spirit_sub:
                    if self.world.tile_id_collision_spirit_sub[type_of_tile].count(tile) == 1:
    ...
    def update_real(self):
        if pyxel.frame_count % 1800 == 0:
            self.world.portals = [p for p in self.world.portals if p["type"] != "portal"]
            for i in range(30):
                tile = random.choice(self.portal_spawnable_tile)
                self.world.portals.append(
                    {
                        "x": tile[0] * 8 - 120,
                        "y": tile[1] * 8 - 120,
                        "purified": False,
        ...
        if near_portal:
            if pyxel.btn(pyxel.KEY_SPACE):
                ...
                if self.ritual_progress >= 60:
                    self.player.portal_id = self.world.portals.index(near_portal)
    ...
    def update_spirit(self):
        ...
        if pyxel.btnp(pyxel.MOUSE_BUTTON_LEFT) and self.player.cooldown == False:
            if self.player.active_attack != None:
                if self.combat.attack_ui[self.player.active_attack]["type"] == "ranged":
                ...
                elif self.combat.attack_ui[self.player.active_attack]["type"] == "closed":
                    pyxel.play(3, 5)
                    self.player.cooldown_start_frame = pyxel.frame_count
            ...
            if not m["stun"]:
                ...
                if self.dist(self.player, m, "x", "y") < 6:
                    ...
                    if path != None:
                        ...
                        if (
                            self.world.portals[self.player.portal_id]["start_time"]
                            == pyxel.frame_count
                        ):
                ...
                if p["type"] == "poison_bomb":
                    ...
                    if self.dist(p, m) < 6:
                        if (
                            ...
                            < self.combat.attack_ui[p["type"]]["damage_frame"] - 1
                        ):
                            m["stun"] = True
                        else:
                            m["stun"] = False
        ...
        self.projectile_info_impact = [
            ...
            < self.combat.attack_ui[p["type"]]["damage_frame"]
        ]
        ...
        if len(self.monsters) == 0:
            ...
            self.world.portals = (
                self.world.portals[: self.player.portal_id]
                + self.world.portals[(self.player.portal_id + 1) :]
            )
        ...
        if pyxel.frame_count % 4 == 0:
            for i in range(200):
                particle = (
                    self.world.portals[self.player.portal_id]["x"] + math.cos(i / 8) * 150,
                    self.world.portals[self.player.portal_id]["y"]
                    + math.sin(i / 8) * 150
                    + random.randint(0, 3)
                    - 15,
                ...
                for type_of_tile in self.world.tile_type:
                    if (
                        self.world.tile_id_collision[type_of_tile].count(tile_of_particle)
                        == 1
                    ):
    ...
    def enter_spirit(self):
        ...
        self.player.immortality = True
        portal = self.world.portals[self.player.portal_id]
        self.world.portals[self.player.portal_id]["start_time"] = pyxel.frame_count
        spawnable_tile_list = []
        if self.state != STATE_SPIRIT_SUB_ZONE:
            self.init_path_map()
            ...
            for tile_x in range(round(math.sin(tile_y / 300 * math.pi) * 300)):
                if tile_y % 8 == 0 and tile_x % 8 == 0:
                    ...
                    if self.dist(portal, {"x": coo_right[0], "y": coo_right[1]}) < 140:
                        ...
                        for type_of_tile in self.world.tile_type:
                            if (
                                self.world.tile_id_collision[type_of_tile].count(tile_right)
                                == 1
                            ):
                        ...
                        for type_of_tile in self.world.tile_type:
                            if (
                                self.world.tile_id_collision[type_of_tile].count(tile_left)
                                == 1
                            ):
                                if ["no_collision_terrain", "path", "ice"].count(
                                    type_of_tile
    ...
    def enter_spirit_sub_zone(self):
        ...
        if portal["type"] == "mine":
            mine = self.world.mine_path[portal["id"]]
            for mine_exit in self.world.mine_exit:
        ...
        for p in self.world.portals:
            if p["type"] == "portal":
                pyxel.blt(
                    ...
                    2,
                    200
                    + (int(self.ui.hud != "pause") * (pyxel.frame_count % 9) // 3) * 16,
                    0,
                    16,
                    16,
                    0,
    ...
    def draw_spirit(self):
        ...
        if self.ui.temp!=[] and self.ui.temp!=None:
            #print(self.ui.temp)
            for tile in self.ui.temp:
        ...
        for p in self.projectile_info_impact:
            if p["type"] == "poison_bomb":
                pyxel.blt(
                    ...
                    2,
                    self.combat.effect_ui[p["type"]]["x"]
                    + ((pyxel.frame_count - p["impact_frame"]) // 3) * 16,
                    self.combat.effect_ui[p["type"]]["y"],
                    self.combat.effect_ui[p["type"]]["u"],
                    self.combat.effect_ui[p["type"]]["v"],
                    self.combat.effect_ui[p["type"]]["col"],
                )
            elif p["type"] == "cryogenis":
                pyxel.blt(
                    p["x"] - self.player.x + 120,
        ...
        if self.player.active_attack != None:
            if self.combat.attack_ui[self.player.active_attack]["type"] == "closed":
                clipping = 0

                if 128 > pyxel.mouse_x and self.ui.ingame_hud.count(self.ui.hud) == 1:
                    clipping = -16
    ...
    def draw_ui(self):
        ...
        if self.ui.hud != None:
            if self.ui.hud == "inventory":
                ...
                for i in range(3):
                    ...
                    if attack_name != None:
                        item = self.combat.attack_ui[attack_name]
                ...
                for i in range(len(self.ui.pause_ui_text_id)):
                    pyxel.blt(
                        ...
                        20 + i * 30,
                        2,
                        self.ui.pause_ui_text_id[i][0],
                        self.ui.pause_ui_text_id[i][1],
                        self.ui.pause_ui_text_id[i][2],
                        8,
                        3,
                    )
                if self.player.slot_at_mouse != [None, None]:
                    ...
                    pyxel.rectb(
                        9,
                        18 + slot_id * 30,
                        self.ui.pause_ui_text_id[slot_id][2] + 3,
                        13,
                        5,
                    )
                    pyxel.trib(
                    ...
                    pyxel.trib(
                        self.ui.pause_ui_text_id[slot_id][2] + 12,
                        19 + slot_id * 30,
                        self.ui.pause_ui_text_id[slot_id][2] + 12,
                        29 + slot_id * 30,
                        self.ui.pause_ui_text_id[slot_id][2] + 17,
                        24 + slot_id * 30,
                        5,
                    )
                    pyxel.tri(
                    ...
                    pyxel.tri(
                        self.ui.pause_ui_text_id[slot_id][2] + 11,
                        19 + slot_id * 30,
                        self.ui.pause_ui_text_id[slot_id][2] + 11,
                        29 + slot_id * 30,
                        self.ui.pause_ui_text_id[slot_id][2] + 16,
                        24 + slot_id * 30,
                        12,
                    )
                    pyxel.rect(
                        9,
                        19 + slot_id * 30,
                        self.ui.pause_ui_text_id[slot_id][2] + 2,
                        11,
                        12,
                    )
                    pyxel.blt(
                        ...
                        20 + slot_id * 30,
                        2,
                        self.ui.pause_ui_text_id[slot_id][0] + 64,
                        self.ui.pause_ui_text_id[slot_id][1],
                        self.ui.pause_ui_text_id[slot_id][2],
                        8,
                        3,
                    )
                ...
                for x in range(2):
                    ui = self.ui.pause_ui_text_id[x * 4]
                    pyxel.blt(64 + x * 105, 174, 2, ui[0], ui[1], ui[2], 8, 3)

                slot_id = self.player.slot_at_mouse[1]
                if slot_id != None:
                    ui = self.ui.pause_ui_text_id[slot_id * 4]
                    pyxel.rectb(
                        62 + slot_id * 105,
                        172,
                        self.ui.pause_ui_text_id[slot_id * 4][2] + 4,
                        13,
                        5,
                    )
                    pyxel.rect(
                        63 + slot_id * 105,
                        173,
                        self.ui.pause_ui_text_id[slot_id * 4][2] + 2,
                        11,
                        12,
                    )
        ...
        for i in range(3):
            ...
            if self.state != STATE_REAL:
                index = (
                    self.player.active_slots.index(self.player.active_attack)
                    + (pyxel.mouse_wheel * (int(self.ui.ingame_hud.count(self.ui.hud) == 1)))
                ) % 3
                pyxel.blt(
                    WIDTH - 112 - 3 + self.combat.attack_ui_slot[index][0],
                    HEIGHT - 60 - 3 + self.combat.attack_ui_slot[index][1],
                    2,
                    0,
                    128,
                    24,
        ...
        for i in range(len(self.ui.qol_loot_ui)):
            loot = self.ui.qol_loot_ui[i]
            pyxel.text(25, HEIGHT - 15 + i * 18, str(loot["type"]), 7)
            pyxel.blt(
                5,
                HEIGHT - 20 + i * 18,
                2,
                self.combat.attack_ui[loot["type"]]["x"],
                self.combat.attack_ui[loot["type"]]["y"],
                16,
                16,
                7,
            )
    ...
    def dist(a, b, base_x="x", base_y="y"):
        a_x = getattr(a, base_x, None) if hasattr(a, base_x) else a.get(base_x, a[base_x])
        a_y = getattr(a, base_y, None) if hasattr(a, base_y) else a.get(base_y, a[base_y])
        b_x = getattr(b, "x", None) if hasattr(b, "x") else b.get("x", b["x"])
        b_y = getattr(b, "y", None) if hasattr(b, "y") else b.get("y", b["y"])
